...
class AuthorCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('tác giả', 'tác giả');
    }
    ...
    protected function setupCreateOperation()
    {
        CRUD::setValidation([
            ...
            'slug' => 'nullable|min:2|max:255|unique:authors,slug'
        ]);

        CRUD::field('name')->label('Tên tác giả');
    ...
    protected function setupUpdateOperation()
    {
        ...
        CRUD::setValidation([
            'name' => 'required|min:2|max:255',
            'slug' => 'nullable|min:2|max:255|unique:authors,slug,' . CRUD::getCurrentEntryId()
        ]);
    }
}