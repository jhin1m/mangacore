...
class ArtistCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('họa sĩ', 'họa sĩ');
    }
    ...
    protected function setupCreateOperation()
    {
        CRUD::setValidation([
            ...
            'slug' => 'nullable|min:2|max:255|unique:artists,slug'
        ]);

        CRUD::field('name')->label('Tên họa sĩ');
    ...
    protected function setupUpdateOperation()
    {
        ...
        CRUD::setValidation([
            'name' => 'required|min:2|max:255',
            'slug' => 'nullable|min:2|max:255|unique:artists,slug,' . CRUD::getCurrentEntryId()
        ]);
    }
}