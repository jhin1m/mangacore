...
class OriginCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(Origin::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/origin');
        CRUD::setEntityNameStrings('xuất xứ', 'xuất xứ');
    }
    ...
    protected function setupCreateOperation()
    {
        CRUD::setValidation([
            ...
            'slug' => 'nullable|min:2|max:255|unique:origins,slug'
        ]);

        CRUD::field('name')->label('Tên xuất xứ');
    ...
    protected function setupUpdateOperation()
    {
        ...
        CRUD::setValidation([
            'name' => 'required|min:2|max:255',
            'slug' => 'nullable|min:2|max:255|unique:origins,slug,' . CRUD::getCurrentEntryId()
        ]);
    }
}